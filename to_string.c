...
/*   Updated: 2021/07/08 22:20:17 by jgomes-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_to_string(t_print *content)
{
	...
	if (s && content->dash && content->wdt) // se tem a flag -, é necessario digitar " ", só depois da string ja estar la

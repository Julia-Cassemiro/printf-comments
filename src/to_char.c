...
/*   Updated: 2021/07/07 02:32:58 by jgomes-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	ft_output_char(t_print *content)
// {
// 	char	a;

// 	a = va_arg(content->args, int);
// 	ft_update_lenght(content, 1);
// 	if (content->wdt && !content->dash)
// 		ft_right_cs(content, 0);
// 	content->tl += write(1, &a, 1);
// 	if (content->wdt && content->dash)
// 		ft_left_cs(content, 0);
// }
